...
LLM#1 (Gemini): Summarizes articles and extracts sentiment and tone.
LLM#2 (OpenRouter/GPT): Validates the analysis to reduce errors.
Modular Code: Separation of concerns for fetching, analyzing, validating.
JSON + Markdown Output: Machine-readable + human-readable formats.
No API keys in code: Environment variables via .env.
Key Design Choices
